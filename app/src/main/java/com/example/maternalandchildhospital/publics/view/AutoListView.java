...
public class AutoListView extends ListView implements OnScrollListener {
	...
	private void initView(Context context) {
		...
		footer = inflater.inflate(R.layout.layout_autolistview_footer, null);
		loadFull = (TextView) footer.findViewById(R.id.loadFull);
		noData = (TextView) footer.findViewById(R.id.noData);
		more = (TextView) footer.findViewById(R.id.more);
		loading = (ProgressBar) footer.findViewById(R.id.loading);

		header = inflater.inflate(R.layout.layout_autolistview_pull_to_refresh_header, null);
...
//		header.setPadding(0, 0, 0, 1);
	...
	public void setResultSize(int resultSize) {
		if (resultSize == 0) {
			...
			isLoadFull = true;
			loadFull.setVisibility(View.GONE);// 加载完成
			loading.setVisibility(View.GONE);
			more.setVisibility(View.GONE);
