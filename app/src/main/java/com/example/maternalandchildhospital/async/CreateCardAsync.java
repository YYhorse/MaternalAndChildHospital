 ...
 *         建卡提交
 */
public class CreateCardAsync extends AsyncTask<Integer, Integer, String> {
	public String api_intf = "/user/createCard";
	...
	public CreateCardAsync(boolean isShowDialog, String userId, String userSessionId, String name, String idCard, String dueBirthday, String community, Context context, UpdateUi uu) {
		updateUi = uu;
		...
		try {
			...
			loginObject.put("name", name);
			loginObject.put("idCard", idCard);
			loginObject.put("dueBirthday", dueBirthday);
			loginObject.put("community", community);
