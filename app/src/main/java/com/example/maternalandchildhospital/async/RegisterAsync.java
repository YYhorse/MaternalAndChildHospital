 ...
 *         注册接口
 */
public class RegisterAsync extends AsyncTask<Integer, Integer, String> {
	public String api_intf = "/user/register";
	...
	public RegisterAsync(String phoneNumber, String password, String pushToken, String verifyCode, Context context, UpdateUi uu) {
		updateUi = uu;
		...
		try {
			...
			loginObject.put("pushToken", pushToken);
